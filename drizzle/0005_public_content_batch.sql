-- Public editorial batch from the user-provided Annie WeChat archive.
...
VALUES (
  'annie-0001', NULL, '认识自己', '从《如何找到自己的热爱（或者说天命）｜上篇》中拆出“核与壳”的判断框架。', '这是个人方法论，发布时避免把“天命”表述成唯一答案。',
  '七月安妮｜公众号', '', '["认识自己","公众号精简"]', 135,
...
VALUES (
  'annie-0002', NULL, '认识自己', '从《如何找到自己的热爱（或者说天命）｜上篇》中提炼识别天赋的方法。', '发布前可补充一个作者自己的具体例子，让观点更可信。',
  '七月安妮｜公众号', '', '["认识自己","公众号精简"]', 132,
  0, '用户提供的公众号原文；首轮精编样稿', '如何找到自己的热爱（或者说天命）｜上篇', '2025-01-18',
...
VALUES (
  'annie-0003', NULL, '身心觉察', '从《到底如何“爱自己”？》中提炼可执行的自我照顾能力。', '可直接发布；避免把消费行为等同于爱自己。',
  '七月安妮｜公众号', '', '["身心觉察","公众号精简"]', 136,
...
VALUES (
  'annie-0004', NULL, '亲密关系', '从《到底如何“爱自己”？》中重新编辑自我负责与关系边界。', '涉及亲密关系边界，发布时应避免将伤害或受害经历归咎于当事人。',
  '七月安妮｜公众号', '', '["亲密关系","公众号精简"]', 130,
...
VALUES (
  'annie-0005', NULL, '自由与商业', '从《为什么说上班耽误赚钱？》中区分岗位经验与商业能力。', '这是对部分岗位的经验性概括，发布时不要扩大为对所有职场和公司的判断。',
  '七月安妮｜公众号', '', '["自由与商业","公众号精简"]', 138,
...
VALUES (
  'annie-0006', NULL, '生活思考', '从《你不一定要大量读书》中提炼阅读数量与问题意识的区别。', '可直接发布；保留“不反对读书，只反对数量崇拜”的语境。',
  '七月安妮｜公众号', '', '["生活思考","公众号精简"]', 136,
...
VALUES (
  'annie-0007', NULL, '生活思考', '从《你不一定要大量读书》中提炼知识与实践的关系。', '可直接发布；避免把阅读与实践写成非此即彼。',
  '七月安妮｜公众号', '', '["生活思考","公众号精简"]', 134,
  0, '用户提供的公众号原文；首轮精编样稿', '你不一定要大量读书', '2025-08-24',
...
VALUES (
  'annie-0008', NULL, '自由与商业', '从《“做IP”是个伪命题》中提炼长期内容品牌的价值主张。', '这是内容品牌方法论，不保证流量或商业结果。',
  '七月安妮｜公众号', '', '["自由与商业","公众号精简"]', 140,
...
VALUES (
  'annie-0009', NULL, '自由与商业', '从《上班内耗的本质：活在“评价系统”中》提炼两套工作逻辑。', '这是对部分职场环境的经验性总结，发布时避免概括所有组织。',
  '七月安妮｜公众号', '', '["自由与商业","公众号精简"]', 142,
...
VALUES (
  'annie-0010', NULL, '创作表达', '从《写给陷入“拧巴”的创作者》中拆分三种内容任务。', '可直接发布；三种分类是创作方法论，不是平台的统一标准。',
  '七月安妮｜公众号', '', '["创作表达","公众号精简"]', 142,
...
VALUES (
  'annie-0011', NULL, '创作表达', '从《写给陷入“拧巴”的创作者》中提炼目标冲突。', '可直接发布，可与上一张卡成组使用。',
  '七月安妮｜公众号', '', '["创作表达","公众号精简"]', 138,
  0, '用户提供的公众号原文；首轮精编样稿', '写给陷入“拧巴”的创作者', '2026-07-10',
...
VALUES (
  'annie-0012', NULL, '自由与商业', '从《有技能有天赋，如何变成钱？》中提炼技能产品化。', '涉及商业转化，发布前应结合具体案例，不承诺收入结果。',
  '七月安妮｜公众号', '', '["自由与商业","公众号精简"]', 145,
...
VALUES (
  'annie-0013', NULL, '认识自己', '从《有技能有天赋，如何变成钱？》中提炼行动与反馈对天赋识别的作用。', '可直接发布；避免把天赋写成固定不变的先天属性。',
  '七月安妮｜公众号', '', '["认识自己","公众号精简"]', 140,
...
VALUES (
  'annie-0014', NULL, '认识自己', '从《在意他人评价/讨好型人格本质是因为缺乏「主体性」》中提炼注意力归属。', '避免把主体性写成自我中心；重点是恢复判断和选择。',
  '七月安妮｜公众号', '', '["认识自己","公众号精简"]', 133,
...
VALUES (
  'annie-0015', NULL, '自由与商业', '从《自由职业唤醒了我的生命力》中提炼自由职业的反馈价值。', '属于个人职业体验，不要写成适用于所有人的职业结论。',
  '七月安妮｜公众号', '', '["自由与商业","公众号精简"]', 130,
...
VALUES (
  'annie-0016', NULL, '认识自己', '从《强者必过这一关》中提炼结果与自我价值解绑。', '用个人成长观点表达，避免承诺“不怕失败就一定成功”。',
  '七月安妮｜公众号', '', '["认识自己","公众号精简"]', 128,
...
VALUES (
  'annie-0017', NULL, '选择与命运', '从《记录一次人生重要选择》中提炼外部好牌与内心选择的冲突。', '不要浪漫化裸辞或冲动决策，应保留现实条件与风险评估。',
  '七月安妮｜公众号', '', '["选择与命运","公众号精简"]', 131,
...
VALUES (
  'annie-0018', NULL, '选择与命运', '从《建立人生主线的道与术》中提炼主线作为决策过滤器的作用。', '这是个人规划框架，不把人生主线包装成唯一正确答案。',
  '七月安妮｜公众号', '', '["选择与命运","公众号精简"]', 134,
...
VALUES (
  'annie-0019', NULL, '选择与命运', '从《如何确定「我想要什么？」》中提炼结果问题与过程问题的差别。', '保留方法论属性，不承诺只要喜欢过程就能得到结果。',
  '七月安妮｜公众号', '', '["选择与命运","公众号精简"]', 137,
...
VALUES (
  'annie-0020', NULL, '亲密关系', '从《关于生育》中提炼生育选择的主体性。', '生育议题涉及健康、家庭与现实条件，发布前需核实表达并避免替他人下结论。',
  '七月安妮｜公众号', '', '["亲密关系","公众号精简"]', 126,
...
VALUES (
  'annie-0021', NULL, '身心觉察', '从《把情绪当作「手段」而非「目的」》中提炼情绪与行动的关系。', '避免将情绪工具化为操控他人的手段。',
  '七月安妮｜公众号', '', '["身心觉察","公众号精简"]', 132,
...
VALUES (
  'annie-0022', NULL, '亲密关系', '从《如何接受「不被爱」？》中提炼关系结果与自我价值解绑。', '作为关系观点发布，避免替具体关系中的当事人做决定。',
  '七月安妮｜公众号', '', '["亲密关系","公众号精简"]', 136,
...
VALUES (
  'annie-0023', NULL, '亲密关系', '从《如何接受「不被爱」？》中提炼支持独立性的爱。', '避免将任何单一关系观包装成唯一标准。',
  '七月安妮｜公众号', '', '["亲密关系","公众号精简"]', 127,
  0, '用户提供的公众号原文；深度筛选并重新编辑', '如何接受「不被爱」？', '2026-04-03',
...
VALUES (
  'annie-0024', NULL, '身心觉察', '从《如何用脑科学改命（很干）》中提炼可执行的反应重写框架。', '原文涉及脑科学解释，发布前需核实相关术语；卡片只保留行为练习。',
  '七月安妮｜公众号', '', '["身心觉察","公众号精简"]', 138,
...
VALUES (
  'annie-0025', NULL, '认识自己', '从《「人如何成为自己」，我实践了一年》中提炼无保证条件下的坚持。', '作为个人经验表达，不把坚持本身等同于必然成功。',
  '七月安妮｜公众号', '', '["认识自己","公众号精简"]', 129,
...
VALUES (
  'annie-0026', NULL, '认识自己', '从《我真正想做的事跟我的工作经验毫不相关怎么办？》中提炼最小实验。', '避免暗示天赋可以替代训练、专业门槛或现实准备。',
  '七月安妮｜公众号', '', '["认识自己","公众号精简"]', 135,
...
VALUES (
  'annie-0027', NULL, '认识自己', '从《走出优绩主义的牢笼》中提炼擅长与喜欢的区别。', '避免否定专业训练和现实责任，鼓励渐进验证。',
  '七月安妮｜公众号', '', '["认识自己","公众号精简"]', 139,
...
VALUES (
  'annie-0028', NULL, '自由与商业', '从《走出优绩主义的牢笼》中提炼兴趣与商业化的先后关系。', '涉及职业和收入决策，发布前需提醒读者评估现金流与风险。',
  '七月安妮｜公众号', '', '["自由与商业","公众号精简"]', 125,
...
VALUES (
  'annie-0029', NULL, '亲密关系', '从《回归「真」我，是一场大补》中提炼人不应被工具化。', '将原文价值判断落到关系与商业的具体边界上。',
  '七月安妮｜公众号', '', '["亲密关系","公众号精简"]', 132,
...
VALUES (
  'annie-0030', NULL, '身心觉察', '从《疗愈只能扶“弱”，行动才能变“强”》中提炼稳定与行动的互补关系。', '心理健康议题需谨慎；不要贬低治疗，也不要把行动替代专业帮助。',
  '七月安妮｜公众号', '', '["身心觉察","公众号精简"]', 124,
...
VALUES (
  'annie-0031', NULL, '自由与商业', '从《如果你被大厂裁员，一定别着急找工作》中提炼缓冲期决策。', '涉及就业和财务决策，必须强调现金流、家庭责任和个体差异。',
  '七月安妮｜公众号', '', '["自由与商业","公众号精简"]', 123,
...
VALUES (
  'annie-0032', NULL, '认识自己', '从《「优绩主义」没有错，但它会锁死你的人生可能性》中提炼解题与出题的差别。', '不否定教育和专业训练，重点补充创造性能力。',
  '七月安妮｜公众号', '', '["认识自己","公众号精简"]', 138,
...
VALUES (
  'annie-0033', NULL, '自由与商业', '从《不想上班，是因为你不想再背叛自己》中提炼个人与组织的错配。', '避免把所有职场不适都归因于组织，也不直接建议离职。',
  '七月安妮｜公众号', '', '["自由与商业","公众号精简"]', 134,
...
VALUES (
  'annie-0034', NULL, '自由与商业', '从《IP一定要创造思想稀缺性》中提炼定位与价值主张的差别。', '作为内容商业方法论发布，避免许诺流量或变现结果。',
  '七月安妮｜公众号', '', '["自由与商业","公众号精简"]', 140,
...
VALUES (
  'annie-0035', NULL, '选择与命运', '从《陈婧霏说适合我的世界并不存在直到我把它创造出来》中提炼理想与方法的关系。', '涉及人物观点时不要虚构引语；卡片采用重新编辑后的独立表达。',
  '七月安妮｜公众号', '', '["选择与命运","公众号精简"]', 137,
