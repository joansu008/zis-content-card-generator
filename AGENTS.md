...
- For generated Xiaohongshu portrait subjects, avoid stiff stock-photo or obvious AI posing. Prefer natural half-body seated or casually leaning speaking moments, with small imperfect gestures, relaxed shoulders and weight, and candid facial expression; do not default to standing three-quarter-body portraits.
- When a source portrait is heavily occluded by an object, preserve naturalness by cropping above the occluder instead of synthesizing hidden hands, limbs, or body areas unless the user explicitly asks for reconstruction.
- Exported transparent portrait assets must be real RGBA PNGs: pixels outside the subject have Alpha 0. Never bake a gray-white checkerboard, solid color, studio backdrop, or transparency-preview pattern into the image pixels.
